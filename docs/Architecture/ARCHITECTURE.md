...
| 精密シャント基準        | Texas Instruments `TLVH431B`       | 1.24 V 動作、0.5%、最大 70 mA 級、4.45 V の能動クランプ制御に使用                      | BQ25570 案の候補     |
...
| 逆流防止                | Texas Instruments `LM66100DCKR`    | 1.5-5.5 V の理想ダイオード。4.45 V クランプ後で蓄電側から発電機への逆流を遮断          | 低電圧始動を要評価   |
...
前段を 4.45 V でクランプすると、BQ25570 がサンプルする `VOC` も約 4.45 V に制限され、50% 設定では約 2.23 V を追従する。客先データから概算した中高出力域の最大電力点は約 8-13 V であり、現行案では回収電力を大きく失う可能性がある。詳細と採用条件は[BQ25570 採用妥当性評価](BQ25570_ASSESSMENT.md)に従う。
