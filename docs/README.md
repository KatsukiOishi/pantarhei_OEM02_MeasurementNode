...
- [Deliverables/CUSTOMER_A4_FACT_PACK.md](Deliverables/CUSTOMER_A4_FACT_PACK.md): 顧客向けA4の根拠となる自己完結型事実パック
- [Deliverables/customer-proposal.pdf](Deliverables/customer-proposal.pdf): A4縦2ページの顧客説明用企画書
- [Deliverables/customer-proposal.html](Deliverables/customer-proposal.html): 企画書の編集・印刷用正本
